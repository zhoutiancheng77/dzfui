 ...
 *
 */
public class PjCheckBVO extends SuperVO {

	@JsonProperty("bid")
	private String pk_bill_check_b;// 子表主键
	@JsonProperty("id")
	private String pk_bill_check_h;// 主表主键
	@JsonProperty("corpid")
	...
	public String getPk_bill_check_b() {
		return pk_bill_check_b;
	}
	...
	public void setPk_bill_check_b(String pk_bill_check_b) {
		this.pk_bill_check_b = pk_bill_check_b;
	}
