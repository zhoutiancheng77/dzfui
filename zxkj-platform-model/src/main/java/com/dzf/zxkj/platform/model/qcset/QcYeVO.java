...
public class QcYeVO extends SuperVO<QcYeVO> implements Comparable<QcYeVO> {
    ...
    @JsonProperty("期间不能为空：period is not null")
    private String period;
    @JsonProperty("年度不能为空：vyear is not null")
    ...
    //排序
    @Override
    public int compareTo(QcYeVO o) {
        return getVcode().compareTo(o.getVcode());
    }
