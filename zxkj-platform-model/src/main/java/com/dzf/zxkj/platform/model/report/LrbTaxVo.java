...
public class LrbTaxVo extends SuperVO {

	public static final String TABLE_NAME = "ynt_report_tax_lrb";

	public static final String PK_FIELD = "pk_report_tax_lrb";

	private String pk_report_tax_lrb;// 主键
	...
	public String getPk_report_tax_lrb() {
		return pk_report_tax_lrb;
	}

	public void setPk_report_tax_lrb(String pk_report_tax_lrb) {
		this.pk_report_tax_lrb = pk_report_tax_lrb;
	}
