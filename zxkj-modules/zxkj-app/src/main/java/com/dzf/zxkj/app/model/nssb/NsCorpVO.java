 ...
 *
 */
public class NsCorpVO extends SuperVO {

	public static final String TABLE_NAME = "bd_corp_ns_app";
	public static final String PK_FIELD = "pk_corp_ns_app";

	private String pk_corp_ns_app;//
	...
	private String iotpassword;// 公司密码
	...
	public String getPk_corp_ns_app() {
		return pk_corp_ns_app;
	}

	public void setPk_corp_ns_app(String pk_corp_ns_app) {
		this.pk_corp_ns_app = pk_corp_ns_app;
	}
