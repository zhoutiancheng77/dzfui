...
import com.dzf.zxkj.platform.service.zncs.IPiaoTongKpService;
...
@Service("piaotongkpservice")
public class PiaoTongKpServiceImpl implements IPiaoTongKpService {
...
//		svo.setSpsl(bsl);
		...
		VATSaleInvoiceBVO[] sbvos = new VATSaleInvoiceBVO[bvos.length];
...
//	private void setBusiName(Map<String, DcModelHVO> map, String spmc, VATSaleInvoiceVO vo){
...
//	}
	...
	private CaiFangTongHVO[] getCaiFangTongBillInfo(CorpVO corpvo, String userid, VATSaleInvoiceVO paramvo){
