...
public class AccsetKeywordBVO2 extends SuperVO {
	
	@JsonProperty("id")
	private String pk_accset_keyword_b2;//主键
	@JsonProperty("pid")
	...
	@JsonProperty("word")
	private String pk_keyword;//关键字主键
	@JsonProperty("wname")
	...
	private List<AccsetKeywordBVO1> list1;//关键字组详情
	...
	public List<AccsetKeywordBVO1> getList1() {
		return list1;
	}

	public void setList1(List<AccsetKeywordBVO1> list1) {
		this.list1 = list1;
	}
	...
	public String getPk_accset_keyword_b2() {
		return pk_accset_keyword_b2;
	}

	public void setPk_accset_keyword_b2(String pk_accset_keyword_b2) {
		this.pk_accset_keyword_b2 = pk_accset_keyword_b2;
	}
