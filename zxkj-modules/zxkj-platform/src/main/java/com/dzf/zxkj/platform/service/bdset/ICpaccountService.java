...
public interface ICpaccountService {
    ...
    Map<String, List<YntCpaccountVO>> queryAccountVO(String userid, String pk_corp, String isShowFC) throws DZFWarpException;
     ...
     * @return
     */
    boolean checkIsQuote(YntCpaccountVO vo) throws DZFWarpException;

    boolean checkIsPzRef(YntCpaccountVO vo) throws DZFWarpException;

    void saveSyncTdAccount(CorpVO cvo) throws DZFWarpException;

    boolean checkQCYE(YntCpaccountVO vo) throws DZFWarpException;

    boolean checkFzhsQCYE(YntCpaccountVO vo) throws DZFWarpException;
     ...
     */
    boolean checkParentVerification(YntCpaccountVO vo) throws DZFWarpException;
     ...
     */
    void perCheckForAddKeMu(YntCpaccountVO data, CorpVO corpvo);
     ...
     * @throws DZFWarpException
     */
    String queryCurrencyRef(YntCpaccountVO vo) throws DZFWarpException;
