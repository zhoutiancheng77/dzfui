...
@Service("taxRptservice_anhui")
public class AhTaxRptServiceImpl extends DefaultTaxRptServiceImpl {
	@Override
...
//				if(PeriodType.jidureport == reportvo.getPeriodtype()){//季报才校验
					if (StringUtil.isEmpty((String) spreadtool.getCellValue(mapJson, rpt1, 32, 8))) {//小型微利企业
