...
import com.dzf.zxkj.platform.model.tax.chk.TaxRptChk10101_henan;
import com.dzf.zxkj.platform.model.tax.chk.TaxRptChk10102_henan;
...
@Service("taxRptservice_henan")
public class HenanTaxRptServiceImpl extends DefaultTaxRptServiceImpl {
	@Override
	...
	public String[] getCondition(String pk_taxreport, UserVO userVO,
		...
		if (TaxRptConst.SB_ZLBH10101.equals(reportvo.getSb_zlbh())) {
			String[] sacondition = TaxRptChk10101_henan.saCheckCondition;
			// 读取报表内容
			...
			String[] sacondition = TaxRptChk10102_henan.saCheckCondition;
			// 读取报表内容
			SQLParameter params = new SQLParameter();
			params.addParam(reportvo.getPk_taxreport());
			TaxReportDetailVO[] vos = (TaxReportDetailVO[]) sbo
