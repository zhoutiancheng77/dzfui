...
import com.dzf.zxkj.platform.services.report.IKMMXZReport;
...
public class KMMXZReportImpl implements IKMMXZReport {
    ...
    @Autowired
    private IPersonalSetService gl_gxhszserv = null;//取科目名称显示方式

    @Autowired
    private IBDCurrencyService sys_currentserv;

    @Autowired
    IAuxiliaryAccountService accountservice;
    @Autowired
    ...
    public List<KmMxZVO> getResultVos(Map<String, KmMxZVO> qcmapvos, Map<String, List<KmMxZVO>> fsmapvos,
        ...
        AuxiliaryAccountHVO[] fzhvos = accountservice.queryH(pk_corp);
