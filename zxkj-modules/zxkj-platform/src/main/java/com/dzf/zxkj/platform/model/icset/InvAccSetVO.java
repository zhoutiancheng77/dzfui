...
public class InvAccSetVO extends SuperVO {
    ...
    public static String[] NAMES = new String[] { "cg_ztwzkm", "cg_yjjxskm", "cg_yfzkkm", "cg_xjfkkm", "xs_xjskkm", "xs_yszkkm",
    ...
    public static void setDefaultValue(Map<Integer,String> colmap, InvAccSetVO setvo){
		Map<String,Integer> keyMap = new HashMap<>();
		keyMap.put("cg_yjjxskm",0);
		keyMap.put("cg_yfzkkm",1);
		keyMap.put("cg_xjfkkm",2);
		keyMap.put("xs_xjskkm",3);
		keyMap.put("xs_yszkkm",4);
		keyMap.put("xs_yysrkm",5);
		keyMap.put("xs_yjxxskm",6);
		keyMap.put("ll_clcbkm",7);
		keyMap.put("ll_yclkm",8);
		keyMap.put("vdef1",9);
		keyMap.put("vdef2",10);
		keyMap.put("vdef3",11);
		keyMap.put("vdef4",12);
		keyMap.put("vdef5",13);
		keyMap.put("vdef6",14);
		keyMap.put("zgrkdfkm",15);
		keyMap.put("xs_clsrkm",16);

		for(Map.Entry<String,Integer> entry : keyMap.entrySet()){
            setvo.setAttributeValue(entry.getKey(),colmap.get(entry.getValue()));
        }
	}
