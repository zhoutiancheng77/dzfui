...
import com.dzf.zxkj.platform.services.report.*;
...
//		} 
	...
	private LrbVO[] getLRB2007VOs(Map<String, FseJyeVO> map, Map<String, YntCpaccountVO> mp, String qjz, String pk_corp,
		...
		String queryAccountRule = gl_cpacckmserv.queryAccountRule(pk_corp);
		LrbVO vo1 = new LrbVO();
		vo1.setXm("一、营业收入");
		...
		String newRuleCode = gl_accountcoderule.getNewRuleCode("630101", DZFConstant.ACCOUNTCODERULE, queryAccountRule);
		...
		newRuleCode = gl_accountcoderule.getNewRuleCode("671101", DZFConstant.ACCOUNTCODERULE, queryAccountRule);
	...
	private LrbVO[] getLRB2013VOs(Map<String, FseJyeVO> map, Map<String, YntCpaccountVO> mp, String rq, String pk_corp,
		...
		vo4.setXm("其中：消费税");
		String queryAccountRule = gl_cpacckmserv.queryAccountRule(pk_corp);
		String newRuleCode = gl_accountcoderule.getNewRuleCode("540301", DZFConstant.ACCOUNTCODERULE, queryAccountRule);
		...
		LrbVO vo5 = new LrbVO();
		vo5.setXm("　　　营业税");
		String newRuleCode1 = gl_accountcoderule.getNewRuleCode("540302", DZFConstant.ACCOUNTCODERULE,
				queryAccountRule);
		...
		LrbVO vo6 = new LrbVO();
		vo6.setXm("　　　城市维护建设税");
		String newRuleCode2 = gl_accountcoderule.getNewRuleCode("540303", DZFConstant.ACCOUNTCODERULE,
				queryAccountRule);
		...
		LrbVO vo7 = new LrbVO();
		vo7.setXm("　　　资源税");
		String newRuleCode3 = gl_accountcoderule.getNewRuleCode("540304", DZFConstant.ACCOUNTCODERULE,
				queryAccountRule);
		...
		LrbVO vo8 = new LrbVO();
		vo8.setXm("　　　土地增值税");
		String newRuleCode4 = gl_accountcoderule.getNewRuleCode("540305", DZFConstant.ACCOUNTCODERULE,
				queryAccountRule);
		...
		String newRuleCode5 = gl_accountcoderule.getNewRuleCode("540306", DZFConstant.ACCOUNTCODERULE,
				queryAccountRule);
		...
		String newRuleCode6 = gl_accountcoderule.getNewRuleCode("540307", DZFConstant.ACCOUNTCODERULE,
				queryAccountRule);
		...
		LrbVO vo12 = new LrbVO();
		vo12.setXm("其中：商品维修费");
		String newRuleCode7 = gl_accountcoderule.getNewRuleCode("560116", DZFConstant.ACCOUNTCODERULE,
				queryAccountRule);
		...
		String newRuleCode8 = gl_accountcoderule.getNewRuleCode("560105", DZFConstant.ACCOUNTCODERULE,
				queryAccountRule);
		...
		LrbVO vo15 = new LrbVO();
		vo15.setXm("其中：开办费");
		String newRuleCode9 = gl_accountcoderule.getNewRuleCode("560208", DZFConstant.ACCOUNTCODERULE,
				queryAccountRule);
		...
		LrbVO vo16 = new LrbVO();
		vo16.setXm("　　　业务招待费");
		String newRuleCode10 = gl_accountcoderule.getNewRuleCode("560204", DZFConstant.ACCOUNTCODERULE,
				queryAccountRule);
		...
		LrbVO vo17 = new LrbVO();
		vo17.setXm("　　　研究费用");
		String newRuleCode11 = gl_accountcoderule.getNewRuleCode("560220", DZFConstant.ACCOUNTCODERULE,
				queryAccountRule);
		...
		LrbVO vo19 = new LrbVO();
		String newRuleCode12 = gl_accountcoderule.getNewRuleCode("560301", DZFConstant.ACCOUNTCODERULE,
				queryAccountRule);
		...
		vo23.setXm("其中：政府补助");
		String newRuleCode13 = gl_accountcoderule.getNewRuleCode("530104", DZFConstant.ACCOUNTCODERULE,
				queryAccountRule);
		...
		vo25.setXm("其中：坏账损失");
		String newRuleCode14 = gl_accountcoderule.getNewRuleCode("571108", DZFConstant.ACCOUNTCODERULE,
				queryAccountRule);
		...
		String newRuleCode15 = gl_accountcoderule.getNewRuleCode("571109", DZFConstant.ACCOUNTCODERULE,
				queryAccountRule);
		...
		String newRuleCode16 = gl_accountcoderule.getNewRuleCode("571110", DZFConstant.ACCOUNTCODERULE,
				queryAccountRule);
		...
		String newRuleCode17 = gl_accountcoderule.getNewRuleCode("571111", DZFConstant.ACCOUNTCODERULE,
				queryAccountRule);
		...
		vo29.setXm("　　　税收滞纳金");
		String newRuleCode18 = gl_accountcoderule.getNewRuleCode("571112", DZFConstant.ACCOUNTCODERULE,
				queryAccountRule);
...
//			}
	...
	private LrbVO[] getLRB2007VOsByPeriod(Map<String, FseJyeVO> map, Map<String, YntCpaccountVO> mp, String pk_corp,
		...
		String queryAccountRule = gl_cpacckmserv.queryAccountRule(pk_corp);
		String newRuleCode = gl_accountcoderule.getNewRuleCode("671101", DZFConstant.ACCOUNTCODERULE, queryAccountRule);
	...
	public LrbVO[] getLrbDataForCwBs(String qj, String corpIds, String qjlx) throws DZFWarpException {
		CorpVO cpvo = corpService.queryByPk(corpIds);
...
//			lrbvos = gl_rep_lrbserv.getLRBVOs(paramVO);
			...
			/** 如果是一般企业则取上年数据 */
			Integer corpschema = yntBoPubUtil.getAccountSchema(corpIds);
			/** 07科目体系(一般企业) */
			if (corpschema == DzfUtil.SEVENSCHEMA.intValue()) {
				/** 查询上年数据 */
