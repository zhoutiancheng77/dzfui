...
public class SalaryAccSetVO extends SuperVO {
	...
	private DZFBoolean isnext;// 是否下月发放
	private String jtgz_gzfykm;// 工资费用科目
	private String jtgz_lwfykm;// 劳务费用科目
	...
	public DZFBoolean getIsnext() {
		return isnext;
	}

	public void setIsnext(DZFBoolean isnext) {
		this.isnext = isnext;
	}

	public String getJtgz_lwfykm() {
		return jtgz_lwfykm;
	}

	public void setJtgz_lwfykm(String jtgz_lwfykm) {
		this.jtgz_lwfykm = jtgz_lwfykm;
	}
	...
	public static String[] getFileds() {
		String[] strs = new String[] { "jtgz_gzfykm", "jtgz_lwfykm","jtgz_yfgzkm", "ffgz_yfgzkm", "ffgz_sbgrbf", "ffgz_gjjgrbf",
				...
				"jitgz_qyfysybxbf", "jitgz_qyfygjjgrbf", "jitgz_qyfygsbxkm", "jitgz_qyfyshybxkm" ,"jtgz_lwfykm","isnext"};
		return strs;
	}

	public static void setDefaultValue(Map<String,String> colmap, SalaryAccSetVO salaryTemp){

		Map<String,String> keyMap = new HashMap<>();
		keyMap.put("jtgz_gzfykm","工资费用科目0");
		keyMap.put("jtgz_lwfykm","劳务费用科目0");
		keyMap.put("jtgz_yfgzkm","应付工资科目0");
		keyMap.put("jtgz_yfsbkm","应付社保科目0");
		keyMap.put("jtgz_sbfykm","社保费用科目0");
		keyMap.put("ffgz_yfgzkm","应付工资科目1");
		keyMap.put("ffgz_gjjgrbf","公积金个人部分1");
		keyMap.put("ffgz_grsds","应缴个税科目1");
		keyMap.put("ffgz_xjlkm","工资发放科目1");
		keyMap.put("ffgz_sbgrbf","个人养老保险1");
		keyMap.put("ffgz_yilbxbf","个人医疗保险1");
		keyMap.put("ffgz_sybxbf","个人失业保险1");
		keyMap.put("ffgz_gsbxkm","工伤保险科目1");
		keyMap.put("ffgz_shybxkm","生育保险科目1");

		for(Map.Entry<String,String> entry : keyMap.entrySet()){
			salaryTemp.setAttributeValue(entry.getKey(),colmap.get(entry.getValue()));
		}
	}
}
