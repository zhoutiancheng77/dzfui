package com.dzf.zxkj.platform.service.st;
...
public interface INssbReportSrv {
...
//	public abstract Map<String,StBaseVO[]> GenNssbBasicReport(String cyear,String pk_corp) throws BusinessException;
	 ...
	 * 单表查询
	 * */
	public StBaseVO[] querySingleReport(String reportcode, String cyear, String pk_corp);
