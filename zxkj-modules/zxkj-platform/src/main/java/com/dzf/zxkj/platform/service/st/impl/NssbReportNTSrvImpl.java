...
@Service("nssbntsrv")
@Slf4j
public class NssbReportNTSrvImpl extends ReportOneTabCommonProcess implements INssbNTReportSrv {
	

	/****
	 * 月  --> 科目对照发生额，KEY=报表项目编号
	 */
	//private Map<String,FseJyeVO> fseMap_month;
	...
	public void saveNssbInfo(CallInfoVO callInfo){
		...
		oldvo.setType(StNssbInfoVO.TYPE00001);
	...
	public Map<String, Class> getTabCodeClassMap() {
		return ReportTabClassMapping.normalTax;
	}
	...
	public SQLParameter getNssbWhereSqlParameter(CallInfoVO callInfo) {
		...
		sp.addParam(param.getYear());
		sp.addParam(param.getYmonth());
		sp.addParam(StNssbInfoVO.TYPE00001);
