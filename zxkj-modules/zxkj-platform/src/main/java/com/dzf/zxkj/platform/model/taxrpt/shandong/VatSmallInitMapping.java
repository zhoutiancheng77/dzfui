 ...
 *
 */
public class VatSmallInitMapping implements InitFiledMapParse {
	private static String[] fields = new String[] { "zzsxgmnsrqcsxxGrid", "sbZzsxgmnsrqtxxVO", "yjxxGrid" };
...
//		hwNameMap.put("bqyjse_hwlw_bqs", "ynsehj");
		...
		fwNameMap.put("skqjfp5_fwbdc_bnlj", "skqjkjdfpbhsxse2");
		...
		//  办税人姓名
		attachNameMap.put("bsrxm", "bsrxm");
		//财务负责人姓名
		attachNameMap.put("cwfzrxm", "cwfzrxm");
		// 法定代表人（负责人）
		attachNameMap.put("fddbrxm", "fddbrxm");
		// 办税人联系电话
		attachNameMap.put("bsrlxdh", "bsrlxdh");
		
		yjhwMap = new HashMap<String, String>();
		yjhwMap.put("bqyjse_hwlw_bqs", "yjye");
		yjfwMap = new HashMap<String, String>();
		yjfwMap.put("bqyjse_fwbdc_bqs", "yjye");
	}
