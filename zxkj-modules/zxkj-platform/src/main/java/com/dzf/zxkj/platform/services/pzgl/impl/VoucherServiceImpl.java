...
import com.dzf.zxkj.platform.services.tax.ITaxCalculateArchiveService;
import com.dzf.zxkj.platform.services.zcgl.IAssetCard;
import com.dzf.zxkj.platform.services.zcgl.IAssetCleanService;
import com.dzf.zxkj.platform.services.zcgl.IYzbgService;
import com.dzf.zxkj.platform.services.zcgl.IZczjmxReport;
...
//				taxvo.setTaxratio(item.getTaxratio());
	...
	public String checkChannelContract(String gs) throws DZFWarpException {
		...
		for(int i = 0; i < fathers.size(); i++){
			unitname = CodeUtils1.deCode(fathers.get(i).getUnitname());
			sf.append(unitname);
			sf.append(",");
