...
public class IctradeinVO extends SuperVO {
	...
	@JsonProperty("id_ictradein")
	private String pk_ictradein;
	...
	// ---------------
	public static String pkFieldName = "pk_ictradein";
	...
	public String getPk_ictradein() {
		return pk_ictradein;
	}

	public void setPk_ictradein(String pk_ictradein) {
		this.pk_ictradein = pk_ictradein;
	}
...
//		fieldColumn.put(8, "invtype");
		...
		fieldColumn.put(15, "vpaywayname");
		fieldColumn.put(16, "fp_style");
		fieldColumn.put(17, "dinvid");
		fieldColumn.put(18, "dinvdate");
		fieldColumn.put(19, "vbankaccname");
		fieldColumn.put(20, "vcustname");
		fieldColumn.put(21, "iszg");
		return fieldColumn;
	}
