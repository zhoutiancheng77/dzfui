...
public class PopularRpForZcfzImpl {
	...
	public PopularRpForZcfzImpl(ICpaccountService gl_cpacckmserv, ICpaccountCodeRuleService gl_accountcoderule){
	...
	public ICpaccountCodeRuleService getGl_accountcoderule() {
		return gl_accountcoderule;
	}

	@Autowired
	public void setGl_accountcoderule(ICpaccountCodeRuleService gl_accountcoderule) {
		this.gl_accountcoderule = gl_accountcoderule;
	}



	public ZcFzBVO[] getPopularZCFZBVOs(Map<String, FseJyeVO> map, String[] hasyes, Map<String, YntCpaccountVO> mapc, String pk_corp) throws BusinessException {
		...
		String newRuleCode = gl_accountcoderule.getNewRuleCode("142101", DZFConstant.ACCOUNTCODERULE, queryAccountRule);
		...
		clearTempVO(votemp);
		String newRuleCode_c = gl_accountcoderule.getNewRuleCode("142102", DZFConstant.ACCOUNTCODERULE, queryAccountRule);
