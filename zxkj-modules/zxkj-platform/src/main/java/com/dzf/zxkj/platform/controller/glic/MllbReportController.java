...
public class MllbReportController  extends GlicReportController{
    ...
    public ReturnData<Json> queryAction(@RequestParam Map<String, String> param){
        ...
        writeLogRecord(LogRecordEnum.OPE_KJ_CHGL,new StringBuffer().append("毛利率统计表查询:").append(param.get("beginPeriod")).append("至").append(param.get("endPeriod")).toString(), ISysConstants.SYS_2);
