...
public class VatOrdinaryInitMapping implements InitFiledMapParse {

	private static String[] fields = new String[] { "sbZzsybnsrqtxxVO", "sbZzsybnsrsynqcsxxGrid", "sbZzsybnsrqcsxxGrid",
			"sbZzsybnsrfbsanqcsxxGrid", "sbZzsybnsrfbsiqcsxxGrid", "sbZzsybnsrfbwuqcsxxGrid",
			"sbZzsybnsrfbgdzcqcsxxGrid" };

	// 主表
	private static Map<String, Map<String, String>> masterNameMap;

	// 主表本期(其他业签取数)
	private static Map<String, Map<String, String>> masterNameMap1 = new HashMap<String, Map<String, String>>();
	...
	static {
		Map<String, String> masterNameMap11 = new HashMap<>();
		// 上期留抵税额一般货物及劳务和应税服务本月
		masterNameMap11.put("sqldseybby", "sqldsebys");
		// 上期留抵税额即征即退货物及劳务和应税服务本月
		masterNameMap11.put("sqldsejzby", "sqldsejzjtbys");
		// 免、抵、退应退税额本月
		masterNameMap11.put("mdtytse", "mdtytse");
		// 上期留抵税额本年累计
		masterNameMap11.put("sqldseybbnlj", "sqldsebnlj");
		// 本期缴纳上期应纳税额
		masterNameMap11.put("jqjnsqynseybby", "bqjnsqynse");
		// 本期缴纳欠缴税额
		masterNameMap11.put("bqjnqjseybby", "bqjnqjse");
		// 加计抵减标识
//		masterNameMap11.put("jjdjbz", "jjdjbz");
		masterNameMap1.put("N", masterNameMap11);

		Map<String, String> masterNameMap12 = new HashMap<>();
		// 上期留抵税额一般货物及劳务和应税服务本月
		masterNameMap12.put("sqldseybby", "sqldsebys");
		// 上期留抵税额即征即退货物及劳务和应税服务本月
		masterNameMap12.put("sqldsejzby", "sqldsejzjtbys");
		// 免、抵、退应退税额本月
		masterNameMap12.put("mdtytse", "mdtytse");
		// 上期留抵税额本年累计
		masterNameMap12.put("sqldseybbnlj", "sqldsebnlj");
		// 本期缴纳上期应纳税额
		masterNameMap12.put("jqjnsqynsejzby", "bqjnsqynse");
		// 本期缴纳欠缴税额
		masterNameMap11.put("bqjnqjsejzby", "bqjnqjse");
		masterNameMap1.put("Y", masterNameMap12);
		...
		// 期初未缴税额
		generalNameMap.put("qcmjseybbnlj", "qcwjse");
		// 实收出口开具专用缴款书退税额
		...
		//一般项目加计抵减额计算
//		Map<String, String> attach4NameMap6 = new HashMap<String, String>();
//		attach4NameMap6.put("ybxmjjdjeqcye", "qmye");
//		attach4NameMap.put("6", attach4NameMap6);
//		//即征即退项目加计抵减额计算
//		Map<String, String> attach4NameMap7 = new HashMap<String, String>();
//		attach4NameMap7.put("jzjtxmjjdjeqcye", "qmye");
//		attach4NameMap.put("7", attach4NameMap7);
		...
		FixedAssetsDeductNameMap.put("zzszyfpJxsesqlj", "zzszyfpjxselj");
		FixedAssetsDeductNameMap.put("hgjkzzszyjksJxsesqlj", "hgjkzzszyjksjxselj");
	}
	...
	public Map<String, String> getNameMap(String key) {
		...
		if ("sbZzsybnsrqtxxVO".equals(vo)) {
			...
			return masterNameMap1.get(index);
	...
	public String getIndexField(String vname) {
		...
		if ("sbZzsybnsrqtxxVO".equals(vname)) {
			return "jzjtbz";
		} else if ("sbZzsybnsrqcsxxGrid".equals(vname) || "sbZzsybnsrsynqcsxxGrid".equals(vname)) {
			return "ewblxh";
		} else {
			return "ewbhxh";
		}
