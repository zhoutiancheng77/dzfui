 ...
 *
 */
public class KmmxExcelField extends MuiltSheetAndTitleExceport<KmMxZVO> implements UnitExceport {
    private KmMxZVO[] vos = null;

    private List<KmMxZVO[]> allsheetvos = null;
    ...
    public KmmxExcelField(String nodename, String pk_currency, String currencyname, String qj, String corpname) {
    ...
    public KmmxExcelField(String nodename, String pk_currency, String currencyname, String[] periods, String[] allsheetname, String qj, String corpname) {
        this.nodename = nodename;
        this.pk_currency = pk_currency;
        this.currencyname = currencyname;
    ...
    @Override
    public List<KmMxZVO[]> getAllSheetData() {
        return allsheetvos;
    }
    ...
    public List<KmMxZVO[]> getAllsheetzcvos() {
        return allsheetvos;
    }

    public void setAllsheetzcvos(List<KmMxZVO[]> allsheetzcvos) {
