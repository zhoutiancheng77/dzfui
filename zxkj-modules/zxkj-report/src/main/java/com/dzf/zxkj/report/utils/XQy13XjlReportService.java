...
public class XQy13XjlReportService {
	public XjllbVO[] getXJLLB2013VOs1(Map<Float, XjllbVO> map, String period,
		...
		// "N");//年初
		// }
		getSanKmQcmny(fsmap, corpdate, voWu, period, cpvo,cpavos, DZFBoolean.FALSE);
		// 取科目的期初值
		...
		if (currdate.before(corpdate)) {
			...
			getSanKmQmMny(fsmap, voLiu, DZFBoolean.FALSE,cpvo, cpavos);
		}
...
//		voSan.setHc("13.5");
	...
	private void getSanKmQmMny(Map<String, FseJyeVO> fsmap, XjllbVO voLiu,DZFBoolean is07,CorpVO corpVO, YntCpaccountVO[] yntCpaccountVOS) {
		Set<String> kmcode =  KmschemaCash.getCashSubjectCode1(yntCpaccountVOS, corpVO.getCorptype(),DZFBoolean.TRUE);
		DZFDouble sqje = DZFDouble.ZERO_DBL;
		DZFDouble bqje = DZFDouble.ZERO_DBL;
		FseJyeVO fvo1  =null;
