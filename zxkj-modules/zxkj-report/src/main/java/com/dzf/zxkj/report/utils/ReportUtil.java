...
public class ReportUtil {
    ...
    public ReportUtil(IZxkjPlatformService zxkjPlatformService) {
    ...
    public String getCurrencyByPk(String pk_currency) {
        if (StringUtil.isEmpty(pk_currency)) {
            return "元";
        }
        BdCurrencyVO bdCurrencyVO = zxkjPlatformService.queryCurrencyVOByPk(pk_currency);
        return getCurrencyDw(bdCurrencyVO == null ? "" : bdCurrencyVO.getCurrencyname());
    }

    public String getCurrencyDw(String currency) {
    ...
    public List<AuxiliaryAccountBVO> getFzhsList(String pk_corp, SuperVO svo, Map<String, AuxiliaryAccountBVO> auxMap) {
     ...
     * @return
     */
    public String[] getCombStr(SuperVO vo, String codeField,
     ...
     * @return
     */
    public Map<String, AuxiliaryAccountBVO> getInvAuaccount(String pk_corp) {
    ...
    //获取汇率精度
    public Integer getHlJd(String pk_corp) {
        Integer hljd = 6;
        YntParameterSet setvo = zxkjPlatformService.queryParamterbyCode(pk_corp, "dzf011");
     ...
     * @return
     */
    public QueryParamVO getFseQueryParamVO(CorpVO corp, DZFDate beginDate,
     ...
     * @return
     */
    public String getExcelCellValue(Cell cell, boolean isNum) {
        String val = null;
        if (cell == null) {
            return val;
        }
    ...
    public String[] filterNull(String[] strs) {
    ...
    public String formatqj(String[] periods) {
