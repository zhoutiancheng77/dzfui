...
public interface IFsYeReport {
	 ...
	 * @throws DZFWarpException
	 */
	public Object[] getYearFsJyeVOsLrbquarter(String year, String pk_corp, DZFDate corpdate, DZFBoolean ishasjz, String rptsource)
			throws DZFWarpException;
	 ...
	 * @throws DZFWarpException
	 */
	public FseJyeVO[] getBetweenPeriodFs(DZFDate begdate, DZFDate enddate, Map<String, List<FseJyeVO>> periodfsmap) throws DZFWarpException;
