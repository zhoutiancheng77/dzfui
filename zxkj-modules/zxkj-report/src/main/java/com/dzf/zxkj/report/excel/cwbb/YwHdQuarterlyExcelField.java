...
public class YwHdQuarterlyExcelField implements IExceport<YwHdVO> {
	...
	public Fieldelement[] getFieldInfo() {
		return  new Fieldelement[]{
				...
				new Fieldelement("monfxdx", "本季度限定性",true,2,zeroshownull),
				new Fieldelement("monxdx", "本季度非限定性",true,2,zeroshownull),
				new Fieldelement("monhj", "本季度合计",true,2,zeroshownull),
