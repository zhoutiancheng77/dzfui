...
public interface IKMMXZReport {
	 ...
	 */
	public KmMxZVO[] getKMMXZVOs(QueryParamVO vo, Object[] qryobj) throws DZFWarpException;
	 ...
	 * @throws DZFWarpException
	 */
	public List<KmMxZVO> getKmFSByPeriod(String pk_corp, DZFBoolean ishasjz, DZFBoolean ishassh, DZFDate start, DZFDate end, String kmwhere) throws DZFWarpException ;
	 ...
	 * @throws BusinessException
	 */
	public Map<String, YntCpaccountVO> getKM(String pk_corp, String kmwhere) throws DZFWarpException;
